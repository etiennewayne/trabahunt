                ...
                <div class="column is-10">
                    <div class="box">
                        ...
                        <b-table
                            ...
                            <b-table-column field="applicant_id" label="ID" v-slot="props">
                                {{ props.row.applicant_id }}
                            </b-table-column>
                            ...
                            <b-table-column field="applicant_name" label="Status" v-slot="props">
                                <span class="status accepted" v-if="props.row.is_accepted === 1">Hired</span>
                                <span class="status pending" v-else>Pending</span>
                            </b-table-column>
                            
                            <b-table-column field="applicant_name" label="Contract" v-slot="props">
                                <span class="ended" v-if="props.row.is_end_contract === 1">Ended</span>
                            </b-table-column>

                            <b-table-column label="Action" v-slot="props">
                                <div class="is-flex">
                                    <b-tooltip label="End Contract" type="is-info">
                                        <b-button 
    ...
    methods: {
        ...
        */
        loadAsyncData() {
            ...
            this.loading = true
            axios.get(`/employer/get-applicant-list?${params}`)
                .then(({ data }) => {
                    this.data = [];
        ...
        */
        ...
        endContract(rowId) {
            this.$buefy.dialog.confirm({
                title: 'End contract?',
                type: 'is-info',
                message: 'Are you sure you want to end contract?',
                cancelText: 'Cancel',
                confirmText: 'End contract',
                onConfirm: () => this.endContractSubmit(rowId)
            });
        },
        //execute delete after confirming
        endContractSubmit(rowId) {
            axios.post('/employer/applicant-list-end-contract/' + rowId).then(res => {
                this.loadAsyncData();
            }).catch(err => {
